[![Java CI with Maven](https://github.com/bbotezat/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/bbotezat/spring-petclinic/actions/workflows/maven.yml)
